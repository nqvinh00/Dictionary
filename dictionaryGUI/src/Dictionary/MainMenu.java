...
public class MainMenu extends JFrame {
    /**
     * most of this method generated by JFormDesigner - config component part, functional part by me.
     */
...
//        dm = new DictionaryManagement();
        ...
        //======== frame1 ========
        {
            ...
            //======== panel11 ========
            {
                ...
                panel11.setBorder(new javax.swing.border.CompoundBorder(new javax.swing.border.TitledBorder(new javax.swing.border.EmptyBorder(0
                ,0,0,0), "JFor\u006dDesi\u0067ner \u0045valu\u0061tion",javax.swing.border.TitledBorder.CENTER,javax.swing.border.TitledBorder.BOTTOM
                ,new java.awt.Font("Dia\u006cog",java.awt.Font.BOLD,12),java.awt.Color.red),
                panel11. getBorder()));panel11. addPropertyChangeListener(new java.beans.PropertyChangeListener(){@Override public void propertyChange(java.beans.PropertyChangeEvent e
            ...
            //======== panel12 ========
            {
                ...
                //---- label9 ----
                label9.setText("T\u1eeb \u0111i\u1ec3n Anh - Vi\u1ec7t");
                label9.setForeground(new Color(187, 211, 248));
                label9.setFont(new Font("Inconsolata", Font.BOLD, 26));
                panel12.add(label9);
                label9.setBounds(30, 65, 370, 70);
        ...
        about.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent mouseEvent) {
                ...
                textArea4.setText("\n  Tác giả: Nguyễn Quang Vinh \n  Lớp: K63K1\n  MSSV: 18024129\n  Phần mềm có sử dụng:"
                        ...
                        "- Text to speech API VoiceRSS\n\t   - Hình ảnh và icon từ icon8s.com");
            }
...
//                    dm.addWord(word, input); // old ver, use with dictionaries.txt file
                    try { // new ver, use with database sqlite
                        if (db.addWord(word, input)) {
        ...
        label3.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent mouseEvent) {
                String word = textField2.getText();
                if (!word.equals("")) {
//                    Word deleteWord = dm.dictionaryLookup(word); // old ver, use with dictionaries.txt file
                    try { // new ver, use with sqlite database
                        Word deleteWord = db.findWord(word);
                        if (deleteWord.getWord().length() == 0 && deleteWord.getMeaning().length() == 0) {
                            ...
                            JOptionPane.showConfirmDialog(null, "Bạn có chắc chắn muốn xóa từ \""
                                    + deleteWord.getWord() + "\" ?", "Xóa từ", JOptionPane.YES_NO_OPTION);
        ...
        label4.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent mouseEvent) {
                ...
                if (!word.equals("")) {
                    ...
                    panel.add(label);
                    panel.add(textField);
                    int option = JOptionPane.showOptionDialog(null, panel, "Chỉnh sửa",
...
//                        if (dm.modifyWord(word, input)) { // old ver, use with dictionaries.txt file
                        try { // new ver, use with sqlite database
                            if (db.modifyWord(word, input)) {
...
//                        if (dm.modifyMeaning(word, input)) { // old ver, use with dictionaries.txt file
                        try { // new ver, use with sqlite database
                            if (db.modifyMeaning(word, input)) {
                                JOptionPane.showMessageDialog(null, "Chỉnh sửa thành công");
                            } else {
                                JOptionPane.showMessageDialog(null, "Không tìm thấy từ muốn chỉnh sửa !");
                            }
...
//                words = dm.dictionarySearcher(input); // old ver, use with dictionaries.txt file
//                if (words != null) {
//                    for (Word w : words) {
...
//    private DictionaryManagement dm;
     ...
     * @throws IndexOutOfBoundsException if error
     */
